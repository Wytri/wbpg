...
<html>
    ...
    <body>
        ...
        %>
        <h2 class="alert-danger">Lista de Clientes</h2>
        ...
        <table class="table table-hover">
            <thead>
            <tr class="bg-danger"><th>DNI<th>Nombre<th>Apellido<th>Edad<th>Correo<th>Telefono<th>Ver
            </thead>   
            <%
            ...
            <tr><td><%=x.getDni()%><td><%=x.getNombre()%><td><%=x.getApellido()%><td><%=x.edad()%><td><%=x.getCorreo()%><td><%=x.getTel()%>
                <td>
                    <a class="li" href="serv_control?opc=5&cod=<%=x.getDni()%>">
                        <div style="background-color: #dc3545;" class="liquido"></div>
                        <span>Boletas</span>
                    </a>
            <%
