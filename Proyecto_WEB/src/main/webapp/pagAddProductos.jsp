...
<html>
    ...
    <body>
        ...
        <h2 class="alert-danger">Agregar Producto</h2>
        ...
        <form action="serv_control" method="post" name="fr">
            <table border=1 class="table table-hover">
                ...
                <div class="fila">
                    ...
                    <span>DESCRIPCIÓN: </span><textarea style="width: 100%" type="text" id="txtdes" name="txtdes" class="campo" required></textarea><br>             
                   <%
